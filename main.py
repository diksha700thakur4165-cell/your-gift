...
# --- Gift 1: Countdown & Rose ---
    ...
    st.write("""
    Har saal bas ek hi dua hai — tum mere saath raho. 
    Tumhari hasi meri taqat hai, aur tumhara pyaar meri sabse badi jeet. 
    Agar poori duniya bhi ulta ho jaaye, main phir bhi tumhara haath pakad ke khadi rahungi. 
    You are the most precious person in my life. Let's make this year amazing! ❤️
    """)
    if st.button("Back"):
        st.session_state.page = 'gift_selection'
        st.rerun()
    ...
    st.markdown(f"""
        <div style="border: 10px solid #FFD700; padding: 30px; text-align: center; background-color: white; border-radius: 15px; font-family: 'Georgia';">
            ...
            <p style="font-size: 18px; color: #7f8c8d; line-height: 1.6;">
                Awarded for your endless patience, your cute smile, <br> 
                and for always being the best partner a girl could ask for. <br>
                You are officially my favorite human!
            </p>
            <br>
            <div style="display: flex; justify-content: space-around; margin-top: 20px;">
                <div style="border-top: 1px solid #333; width: 150px;">
                    <p style="font-size: 14px;">Date: 01-01-2026</p>
                </div>
                <div style="border-top: 1px solid #333; width: 150px;">
                    <p style="font-size: 14px;">Signed by: Diksha ❤️</p>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
