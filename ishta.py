...
# --- Custom CSS for Falling Hearts & Audio Fix ---
st.markdown("""
    <style>
...
if st.session_state.page == 'envelope_back':
    ...
    with col1:
        if st.button("YES (Start Music 🎵)"):
            # Yaha music trigger hoga jab wo "YES" click karenge
...
# --- Music Player (Sirf YES ke baad bajega) ---
